...
//    AT45xxx_protectBlock(false,Index);
    ...
    packageNum = (AddrRange->end - AddrRange->start + mem_id.PageSizeInByte- 1) / mem_id.PageSizeInByte;
    itrCnt =  packageNum *  mem_id.PageSizeInByte / pageSize[idx];
...
//Simon		return false ;
    ...
    // wait until WIP = 0
    if (!SerialFlash_waitForWIP(Index))
	return 1;
...
int S70FSxxx_Large_doRDSR1V(bool die1, unsigned char *cSR,int Index)
{
    ...
    // first control packet
    vInstruction[0] = 0x65;
    vInstruction[1] = ((0x800000>>24)|(die1?0:(0x4000000>>24))) & 0xff;
    vInstruction[2] = (0x800000>>16)&0xff;
    vInstruction[3] = (0x800000>>8)&0xff;
    vInstruction[4] = (0x800000)&0xff;
    vInstruction[5] = 0;
    vInstruction[6] = 0;
...
int S70FSxxx_Large_doRDCR2V(bool die1, unsigned char *cSR,int Index)
{
    ...
    // first control packet
    vInstruction[0] = 0x65;
    vInstruction[1] = ((0x800003>>24)|(die1?0:(0x4000000>>24)))&0xff;
    vInstruction[2] = (0x800003>>16)&0xff;
    vInstruction[3] = (0x800003>>8)&0xff;
    vInstruction[4] = (0x800003)&0xff;
    vInstruction[5] = 0;
    vInstruction[6] = 0;
...
bool S70FSxxx_Large_chipErase(unsigned int Addr,unsigned int Length,int USBIndex)
{
    ...
    return S70FSxxx_Large_waitForWIP(false,USBIndex);
}
